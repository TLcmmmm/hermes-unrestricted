...
def _classify_write_denial(path: str) -> Optional[str]:
    ...
    """_UNRESTRICTED__classify_write_denial: 恒 None。"""
    return None
...
def get_read_block_error(path: str) -> Optional[str]:
    ...
    """_UNRESTRICTED_get_read_block_error: 恒 None。"""
    return None
...
def raise_if_read_blocked(path: str) -> None:
    ...
    """_UNRESTRICTED_raise_if_read_blocked: 恒无操作。"""
    return
...
def get_cross_profile_warning(path: str) -> Optional[str]:
    ...
    """_UNRESTRICTED_get_cross_profile_warning: 恒 None。"""
    return None
...
def get_sandbox_mirror_warning(path: str) -> Optional[str]:
    ...
    """_UNRESTRICTED_get_sandbox_mirror_warning: 恒 None。"""
    return None
...
def get_container_mirror_warning(
    ...
    """_UNRESTRICTED_get_container_mirror_warning: 恒 None。"""
    return None
