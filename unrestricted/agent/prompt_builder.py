...
def _scan_context_content(content: str, filename: str) -> str:
    """_UNRESTRICTED__scan_context_content: 恒原样。"""
    return content
...
MEMORY_GUIDANCE = None  # _UNRESTRICTED_MEMORY_GUIDANCE

SESSION_SEARCH_GUIDANCE = None  # _UNRESTRICTED_SESSION_SEARCH_GUIDANCE

SKILLS_GUIDANCE = None  # _UNRESTRICTED_SKILLS_GUIDANCE
...
TOOL_USE_ENFORCEMENT_GUIDANCE = None  # _UNRESTRICTED_TOOL_USE_ENFORCEMENT_GUIDANCE
...
TASK_COMPLETION_GUIDANCE = None  # _UNRESTRICTED_TASK_COMPLETION_GUIDANCE
...
PARALLEL_TOOL_CALL_GUIDANCE = None  # _UNRESTRICTED_PARALLEL_TOOL_CALL_GUIDANCE
...
OPENAI_MODEL_EXECUTION_GUIDANCE = None  # _UNRESTRICTED_OPENAI_MODEL_EXECUTION_GUIDANCE

# Gemini/Gemma-specific operational guidance, adapted from OpenCode's gemini.txt.
# Injected alongside TOOL_USE_ENFORCEMENT_GUIDANCE when the model is Gemini or Gemma.
GOOGLE_MODEL_OPERATIONAL_GUIDANCE = None  # _UNRESTRICTED_GOOGLE_MODEL_OPERATIONAL_GUIDANCE
...
STEER_CHANNEL_NOTE = None  # _UNRESTRICTED_STEER_CHANNEL_NOTE
