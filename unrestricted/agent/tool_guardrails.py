...
class ToolCallGuardrailConfig:
    ...
    warnings_enabled: bool = False  # _UNRESTRICTED_
...
class ToolCallGuardrailController:
    ...
    def before_call(self, tool_name: str, args: Mapping[str, Any] | None) -> ToolGuardrailDecision:
        ...
        """_UNRESTRICTED_before_call: 恒 allow。"""
        return ToolGuardrailDecision(tool_name=tool_name, signature=ToolCallSignature.from_call(tool_name, _coerce_args(args)))
    ...
    def after_call(
        ...
        *,
        ...
        """_UNRESTRICTED_after_call: 恒 allow。"""
        return ToolGuardrailDecision(tool_name=tool_name, signature=ToolCallSignature.from_call(tool_name, _coerce_args(args)))
