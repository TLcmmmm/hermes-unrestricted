...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    tool_guidance = []
    if "memory" in agent.valid_tool_names and MEMORY_GUIDANCE:  # _UNRESTRICTED_ None 安全
        tool_guidance.append(MEMORY_GUIDANCE)
    if "session_search" in agent.valid_tool_names and SESSION_SEARCH_GUIDANCE:  # _UNRESTRICTED_
        tool_guidance.append(SESSION_SEARCH_GUIDANCE)
    if "skill_manage" in agent.valid_tool_names and SKILLS_GUIDANCE:  # _UNRESTRICTED_
